...
const tabs = [
    { component: 'AboutMe', label: 'About', icon: 'fa fa-user-tie' },
    { component: 'MyResume', label: 'Resume', icon: 'fa fa-file-alt' },
    { component: 'MyWorks', label: 'Works', icon: 'fa fa-paint-brush' },
    { component: 'MyBlog', label: 'Blog', icon: 'fa fa-book' },
  ];
const currentTab = ref('AboutMe');
const currentComponent = computed(() => currentTab.value ? defineAsyncComponent(() =>import(`~/components/${currentTab.value}.vue`)) : '')
